...
set(CPACK_PACKAGE_NAME "InspectorWidgetCollector")
set(CPACK_PACKAGE_VENDOR "github.com/InspectorWidget")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_EXECUTABLES
		"InspectorWidgetCollector32" "InspectorWidgetCollector (32bit)"
		"InspectorWidgetCollector64" "InspectorWidgetCollector (64bit)")
	set(CPACK_CREATE_DESKTOP_LINKS
		"InspectorWidgetCollector32"
		"InspectorWidgetCollector64")
else()
	if(WIN32)
	...
	set(CPACK_PACKAGE_EXECUTABLES "InspectorWidgetCollector${_output_suffix}" "InspectorWidgetCollector")
	set(CPACK_CREATE_DESKTOP_LINKS "InspectorWidgetCollector${_output_suffix}")
endif()

set(CPACK_BUNDLE_NAME "InspectorWidgetCollector")
set(CPACK_BUNDLE_PLIST "${CMAKE_SOURCE_DIR}/cmake/osxbundle/Info.plist")
set(CPACK_BUNDLE_ICON "${CMAKE_SOURCE_DIR}/cmake/osxbundle/InspectorWidgetCollector.icns")
...
if(INSTALLER_RUN)
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "InspectorWidgetCollector")
	...
	set(CPACK_PACKAGE_FILE_NAME "InspectorWidgetCollector-${OBS_VERSION}")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
	if(WIN32)
		set(CPACK_PACKAGE_NAME "InspectorWidgetCollector (64bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "InspectorWidgetCollector64")
	...
	set(CPACK_PACKAGE_FILE_NAME "InspectorWidgetCollector-x64-${OBS_VERSION}")
else()
	if(WIN32)
		set(CPACK_PACKAGE_NAME "OBS Studio (32bit)")
	endif()
	set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "InspectorWidgetCollector32")
	...
	set(CPACK_PACKAGE_FILE_NAME "InspectorWidgetCollector-x86-${OBS_VERSION}")
endif()
